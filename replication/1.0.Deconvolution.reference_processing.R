...
# found the file at this link https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE103322
HNSCC_file_path = "/Users/zacheliason/Downloads/GSE103322_HNSCC_all_data.txt"

all_data <- read.delim2(HNSCC_file_path)
...
# RENAME THIS!! 
colnames(seurat_data@meta.data)[colnames(seurat_data@meta.data) == "non-cancer cell type"] <- "non.cancer.cell.type"
...
# THEY STRAIGHT UP DON'T LIST WHERE THIS IS FROM
# I'm commenting out all the lines I was unable to reproduce
# 
# 
...
save(puram_data, file = "/Users/zacheliason/Documents/Work/payne/puram_data.Robj")                    
